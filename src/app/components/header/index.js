...
class Navigation extends Component {
    ...
    render() {
        let { token, user, searchtxt } = this.state;
        return (
            <div>
                <header className="header clearfix">
                    ...
                    <nav className="navbar navbar-light navbar-expand-lg bg-dark bg-faded osahan-menu">
                        <div className="container-fluid">
                            <a className="navbar-brand" href="/" style={{color: '#fff'}}> <img src="img/logo.png" alt ="brandlogo" width= "150px" height="85px"/></a>
                                ...
                                <div className="navbar-nav mr-auto mt-2 mt-lg-0 margin-auto top-categories-search-main">
                                    <div className="top-categories-search" onSubmit={this.handleClickSearch}>
                                        <div className="input-group">
                                            <input className="form-control" placeholder="Search your product" aria-label="Search products in Your City" type="text" name="searchtxt" value={searchtxt} onChange={(e)=>this.handleChange(e)}/>
